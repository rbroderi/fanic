...
def _encode_alpha_access_cookie(secret: str, max_age: int) -> str:
    ...
    payload_b64 = urlsafe_b64encode(str(expires_at).encode("utf-8")).decode("utf-8").rstrip("=")
...
def _alpha_invite_gate_middleware(app: WSGIApplication) -> WSGIApplication:
    ...
    def gated_app(
        ...
        return _invite_page_response(start_response, next_url=next_url, error_message="")
